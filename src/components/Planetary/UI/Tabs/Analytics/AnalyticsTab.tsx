...
import { getSkillColor } from "@/lib/ui-constants";
...
export const AnalyticsTab: React.FC<AnalyticsTabProps> = ({ planet, variant = "planet" }) => {
  ...
  <>
    ...
    <span className="header-value header-value-accent">STATUS: ATIVA</span>
    </div>
    ...
    <span className="row-value" style={{ "--skill-color": color } as React.CSSProperties}>
    ...
    style={{ "--skill-color": color, "--skill-width": `${tool.proficiency}%` } as React.CSSProperties}
    >
  ...
  <>
    ...
    <span className="header-value header-value-accent">STATUS: ESTABILIZADO</span>
    </div>
    ...
    <span
    className="row-value"
    style={{ "--skill-color": getSkillColor(Number(stat.value)) } as React.CSSProperties}
    >
    {stat.value}/100
    </span>
    </div>
    ...
    className="progress-fill"
    style={{
    "--skill-color": getSkillColor(Number(stat.value)),
    "--skill-width": `${stat.value}%`,
