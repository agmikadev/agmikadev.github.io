...
export const BeltAnalyticsTab: React.FC = () => {
  ...
  return (
    <div className="analytics-container belt-analytics">
      {/* --- HEADER --- */}
      <div className="analytics-main-header">
        <span className="header-label">
          Progresso de Sincroniza\u00e7\u00e3o da Rede S.O.N.D.A.
        </span>
        <span className="header-value" style={{ color: beltColor }}>
          STATUS: ATIVA
        </span>
      </div>
                        ...
                        <div className="alternatives-tags">
                          {tool.relatedTechnologies.map((tech, idx) => (
                            <span
                              ...
                              style={
                                {
                                  border: `1px solid ${beltColor}20`,
                                  color: `${beltColor}cc`,
                                } as React.CSSProperties
                              }
                              onMouseEnter={(e) => {
                                e.currentTarget.style.border = `1px solid ${beltColor}cc`;
                                e.currentTarget.style.boxShadow = `0 0 8px ${beltColor}40`;
                              }}
                              onMouseLeave={(e) => {
                                e.currentTarget.style.border = `1px solid ${beltColor}20`;
